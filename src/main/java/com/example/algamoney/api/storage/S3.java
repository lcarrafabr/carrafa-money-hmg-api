...
public class S3 {
	...
	public String salvarTemporariamente(MultipartFile arquivo) {
		...
		try {
			...
			System.out.println("O prblema está aqui");
			throw new RuntimeException("Problemas ao tentar envuar o arquivo para o S3", e);
		}
	...
	public String configurarURL(String objeto) {
		...
		return "https://" + property.getS3().getBucket() + ".s3.amazonaws.com/" + objeto; //usa se \\\\ no lugar de http ou https. As barras ajustam esse inicio.
	}
	
	public void salvar(String objeto) {
		
		SetObjectTaggingRequest setObjectTaggingRequest = new SetObjectTaggingRequest(property.getS3().getBucket(), objeto, new ObjectTagging(Collections.EMPTY_LIST));
	...
	public void substituir(String objetoAntigo, String objetoNovo) {
		...
		salvar(objetoNovo); //independente se tem ou não objeto antigo, mando tirar a TAG de expirar 
	}
